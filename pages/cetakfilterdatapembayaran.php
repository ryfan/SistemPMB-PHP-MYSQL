...
$sql=mysql_query("SELECT * FROM bayar WHERE tgl_bayar BETWEEN '$daritanggal' AND '$sampaitanggal' ORDER BY no_bayar");
$data = array();
...
$judul = "LAPORAN DATA PEMBAYARAN BERDASARKAN TANGGAL";
$header = array(
