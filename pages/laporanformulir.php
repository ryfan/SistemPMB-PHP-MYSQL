  ...
  <body>
    <div class="navbar-fixed">
        <nav class="indigo darken-4">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              <li class="active"><a href="laporanformulir.php">Laporan Formulir</a></li>
      ...
      <div class="container col s6 offset-s3 card-panel z-depth-3">
              <form action="laporanformulirfilter.php" method="get" style="margin-top:5%;">
              ...
              <div class="input-field col s2 m6">
                ...
                <button class="btn waves-effect red darken-2" type="button" Value="Kembali" Onclick="window.location.href='laporanformulirkeseluruhan.php'">Lihat Laporan Keseluruhan</button>
                <br><br>
              </div>
              </form>
        </div>
