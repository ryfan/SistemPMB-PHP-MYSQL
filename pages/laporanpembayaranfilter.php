        ...
        <nav class="indigo darken-4">
          <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
              ...
              <li><a href="cetakfilterdatapembayaran.php?daritanggal=<?php echo $daritanggal?>&sampaitanggal=<?php echo $sampaitanggal?>" class="waves-effect waves-light btn indigo darken-3 lighten-1" target="_blank">Cetak Data Laporan</a></li>
              <?php } ?>
        ...
        <div class="container">
          <table  class="striped z-depth-3 display indigo darken-4" id="laporanpembayaran" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              $daritanggal   = $_GET['daritanggal'];
              $sampaitanggal = $_GET['sampaitanggal'];
              $query = mysql_query("SELECT * FROM bayar WHERE tgl_bayar BETWEEN '$daritanggal' AND '$sampaitanggal'");
